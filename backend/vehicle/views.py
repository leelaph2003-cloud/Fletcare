...
urlpatterns = [
    ...
    path('mechaniclogin', views.mechanic_login_view, name='mechaniclogin'),
    ...
    # FIX: duplicate 'delete-mechanic/<int:pk>' removed — only one entry kept
    ...
    # Location tracking & KNN
    path('admin-location-tracking', views.admin_location_tracking_view, name='admin-location-tracking'),
    path('update-customer-location', views.update_customer_location_view, name='update-customer-location'),
    path('update-mechanic-location', views.update_mechanic_location_view, name='update-mechanic-location'),
    path('find-nearest-mechanics', views.find_nearest_mechanics_view, name='find-nearest-mechanics'),
    path('mechanic-location-tracking', views.mechanic_location_tracking_view, name='mechanic-location-tracking'),
    ...
    path('customer-invoice-pdf/<int:request_id>', views.customer_invoice_pdf_view, name='customer-invoice-pdf'),
    path('customer-invoice-email/<int:request_id>', views.customer_invoice_email_view, name='customer-invoice-email'),
    path('customer-invoice-bulk-email', views.customer_invoice_bulk_email_view, name='customer-invoice-bulk-email'),
